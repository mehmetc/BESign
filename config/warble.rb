...
Warbler::Config.new do |config|
  ...
  #config.excludes = FileList["beSign.jar","lib/misc/*", "lib/signature_beid.rb", "lib/signature_pk.rb", "box/*", "lib/java/commons*.jar", "ks"]
  ...
  #config.java_libs += FileList["lib/java/bcpkix-jdk15on-151.jar", "lib/java/bcprov-jdk15on-151.jar", "lib/java/itextpdf-5.5.4.jar", "lib/java/smartcardsign-1.0.0.jar"]
